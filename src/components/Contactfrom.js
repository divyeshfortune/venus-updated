  ...
  return (
    ...
    <div className="container">
      <div className="grid md:grid-cols-12 grid-cols-1 md:gap-[1.875rem] gap-0 lg:pt-[7.1875rem] pt-[5.1875rem] lg:pb-[6.5625rem] pb-[4.5625rem]">
        ...
        <div className="lg:mt-0 mt-8 before:content-[''] before:absolute before:bg-[url('/images/form-line.png')] before:bg-no-repeat before:w-[13rem] before:h-[5.75rem] before:top-[5%] before:bg-contain before:left-[35%] before:-z-[1] before:translate-x-full before:lg:inline-block before:hidden after:content-[''] after:absolute after:bg-[url('/images/from-round-line.png')] after:bg-no-repeat after:w-[6.3125rem] after:h-[6.3125rem] after:bg-contain after:top-1/2 after:-left-[25%] after:-z-[1] after:translate-x-1/2 after:translate-y-1/2 after:md:inline-block after:hidden bg-white max-w-[50rem] m-auto pt-[2.1875rem] pb-8 px-[2.375rem] rounded-md relative md:row-start-1 row-start-2 md:col-start-8 col-start-1 row-end-2 col-end-13">
